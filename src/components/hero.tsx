...
export function Hero() {
  return (
    <section className="z-10 flex flex-1 flex-col justify-start gap-4 pt-20">
      <h1 className="text-left font-display text-6xl lg:text-7xl 2xl:text-9xl font-bold  text-black">
        Building beyond
      ...
      <div className="grid w-full xl:grid-cols-[1fr_auto_1fr] items-center lg:gap-16 gap-8 ">
        <p className=" max-w-2xl text-left text-3xl text-black font-medium ">
