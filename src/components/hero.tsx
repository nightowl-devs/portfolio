...
export function Hero() {
  ...
  return (
    <section id="home" className="z-10 flex flex-1 flex-col justify-start gap-4 pt-20">
      <Heading className="text-left font-bold  text-black">
        {t("heading.prefix")}
        <span className="md:mt-8 2xl:ml-48  block 2xl:text-center text-blue 2xl:tracking-[0.40em]">{t("heading.accent")}</span>
      </Heading>
